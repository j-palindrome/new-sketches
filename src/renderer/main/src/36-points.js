...
class p {
  ...
  constructor(e, t) {
    ;(this.gl = e), (this.params = t), (this.frame = 0), (this.lerpParams = o[s])
    const i = []
    ;(i.length = 8),
      i.fill(-1),
      ...
      (this.params.numParticles =
        this.params.simSize * this.params.simSize * this.params.particleDensity),
    ...
    for (let e = 0; e < this.textures.length; e++) this.textures[e] = this._loadTexture(null)
  ...
  updateParticlesHelper() {
    ...
    for (let e = 7; 2 <= e; --e) this.mousePositions[e] = this.mousePositions[e - 2]
    this.gl.uniform1fv(
  ...
  draw() {
    ;(this.params.lerpTime = Math.min(
      ...
      this.params.lerpTime +
        Math.max((1 - this.params.lerpTime) * this.params.convergenceRate, 0.001)
    )),
...
let F = [
  49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 113, 119, 101, 114, 116, 121, 117, 105, 111, 112, 97, 115,
  100, 102, 103, 104, 106, 107, 108, 122, 120, 99, 118, 98, 110, 109, 90, 88, 67, 86, 66, 78, 77
]
function S() {
...
function y(e, t, i, s, r) {
  if (
    ...
    return console.log('Invalid interpolation parameters: ' + e + ' ' + t + ' ' + i), void _()
  ;(A.pastParams = U.lerpParams),
    (A.params = (function (t, i, s) {
      let r = []
      for (let e = 0; e < t.length; ++e) 'number' == typeof t[e] && r.push(c(t[e], i[e], s))
      return r
    })(o[e], o[t], i)),
    (A.lerpTime = 0),
    r &&
      console.log(
        'Interpolation from Point ' + (e + 1) + ' to Point ' + (t + 1) + ' with amount ' + i
      ),
